...
export default create({
  base: 'light', // ✅ Minimalist Light Theme
  ...
  // ✅ UI Backgrounds
  appBg: '#FFFFFF', // Light grey background for the UI
  appContentBg: '#FFFFFF', // White background for content area
  ...
  // ✅ Sidebar (Navigation) - Removed Background Color (Now White)
  sidebarBg: '#FFFFFF',
